...
feature 'TrueAutomation.IO capybara example' do
  scenario 'Clicking on profile dropdown after saving some profile data' do
    ...
    # find(:css, ta('vaadin:mainPage:dropDownMenu', "#dashboard-menu > div > div.v-menubar.v-widget.user-menu.v-menubar-user-menu > span > span.v-menubar-menuitem-caption")).click
